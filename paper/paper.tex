...
\hypersetup{
  pdftitle={WEEK3 REFLECTION},
  pdfauthor={JIEFENG LI},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{WEEK3 REFLECTION\thanks{Code and data are available at: LINK.}}
\usepackage{etoolbox}
\makeatletter
...
After 2020, the points become more dispersed.
